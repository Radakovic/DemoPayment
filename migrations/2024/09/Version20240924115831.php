 ...
 */
final class Version20240924115831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment.invoice (id UUID NOT NULL, payment_method VARCHAR(255) NOT NULL, request JSON NOT NULL, response JSON NOT NULL, expiration_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status invoice_status NOT NULL, description TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
